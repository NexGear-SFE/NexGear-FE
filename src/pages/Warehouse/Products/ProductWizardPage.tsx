...
export function ProductWizardPage() {
  ...
  function validateStep(index: number): boolean {
    ...
    if (index === 2) {
      ...
      if (findDuplicateSkus(effectiveVariants.map((variant) => variant.sku), catalogSkus).size) { setError('SKU phải duy nhất trong toàn catalog, kể cả variant inactive.'); return false }
    }
    return true
  }
