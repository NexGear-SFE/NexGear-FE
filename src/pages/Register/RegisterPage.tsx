  ...
  return (
    <div className="min-h-screen w-full flex flex-col lg:flex-row bg-[#F4F5F7]">
      ...
      <div className="flex-1 flex flex-col justify-between items-center p-4 sm:p-8 lg:p-12 relative overflow-y-auto">
        {/* Top Bar Navigation */}
        <div className="w-full max-w-md flex items-center justify-between mb-4 lg:mb-8">
          <Link
            to="/"
        ...
        <div className="w-full max-w-md bg-white rounded-[12px] shadow-[0px_8px_24px_rgba(4,0,4,0.12)] p-6 sm:p-8 lg:p-10 border-t-4 border-[#E30019] border-x border-b border-[#E0E0E0] my-auto">
          {/* Card Title */}
          <h2 className="font-heading font-bold text-2xl text-[#040004] mb-1.5">
            Đăng ký tài khoản
          </h2>
          <p className="font-body text-sm text-[#636363] mb-6">
          ...
          {isSuccess ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Field 1: Full Name */}
              <div>
                <label htmlFor="register-fullname" className="block text-xs font-semibold text-[#040004] mb-1.5">
                ...
                <input
                  ...
                  className="input-gaming w-full py-2.5 px-3.5 text-sm font-medium"
                />
              </div>

              {/* Field 2: Email or Phone */}
              <div>
                <label htmlFor="register-email-phone" className="block text-xs font-semibold text-[#040004] mb-1.5">
              ...
              {/* Field 3: Password */}
              <div>
                <label htmlFor="register-password" className="block text-xs font-semibold text-[#040004] mb-1.5">
                ...
                <div className="relative flex items-center">
                  <input
                    ...
                    className="input-gaming w-full pr-10 py-2.5 px-3.5 text-sm font-medium"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    aria-label={showPassword ? 'Ẩn mật khẩu' : 'Hiện mật khẩu'}
                    className="absolute right-2.5 text-gray-400 hover:text-gray-700 transition-mechanical cursor-pointer p-1"
                  >
              ...
              <div>
                <label htmlFor="register-confirm-password" className="block text-xs font-semibold text-[#040004] mb-1.5">
              ...
              <div className="pt-1">
                <label className="flex items-start gap-2.5 cursor-pointer select-none">
                  ...
                  />
                  <span className="text-xs text-[#040004] font-medium leading-relaxed">
                    Tôi đồng ý với{' '}
                    <a
                      href="#terms"
                      onClick={(e) => {
              ...
              <button
                type="submit"
                className="btn-primary w-full py-3 text-sm mt-5 shadow-sm font-semibold rounded-[4px] bg-[#E30019] hover:bg-[#B30014] cursor-pointer"
              >
                Đăng ký tài khoản
              </button>
            </form>
          ...
          {/* Login Link Redirect */}
          <div className="text-center text-xs text-[#636363] mt-6 pt-4 border-t border-[#F4F5F7]">
            Đã có tài khoản?{' '}
            <button
              type="button"
              onClick={handleOpenLogin}
              className="text-[#E30019] font-semibold hover:underline cursor-pointer bg-transparent border-0 p-0 ml-1"
            >
              Đăng nhập ngay
            </button>
          </div>
