...
export const initialVariants: ProductVariant[] = [
  { id: 'V001', productId: 'P001', sku: 'ASU-G16-I9-4080', skuSource: 'AUTO', optionValues: [{ option: 'CPU', value: 'i9-14900HX', code: 'I9' }, { option: 'GPU', value: 'RTX 4080', code: '4080' }], purchasePrice: 40000000, serialTracking: true, reorderLevel: 3, status: 'ACTIVE', skuLocked: true, createdAt: now, updatedAt: now },
  { id: 'V002', productId: 'P001', sku: 'ASU-G16-I7-4070', skuSource: 'AUTO', optionValues: [{ option: 'CPU', value: 'i7-14700HX', code: 'I7' }, { option: 'GPU', value: 'RTX 4070', code: '4070' }], purchasePrice: 32000000, serialTracking: true, reorderLevel: 3, status: 'ACTIVE', skuLocked: true, createdAt: now, updatedAt: now },
  { id: 'V003', productId: 'P002', sku: 'MSI-GT77-I9-4090', skuSource: 'AUTO', optionValues: [{ option: 'CPU', value: 'i9-13980HX', code: 'I9' }, { option: 'GPU', value: 'RTX 4090', code: '4090' }], purchasePrice: 78000000, serialTracking: true, reorderLevel: 2, status: 'ACTIVE', skuLocked: true, createdAt: now, updatedAt: now },
  { id: 'V004', productId: 'P003', sku: 'LOG-GPX2-BLK', skuSource: 'AUTO', optionValues: [{ option: 'Màu', value: 'Đen', code: 'BLK' }], purchasePrice: 2200000, serialTracking: false, reorderLevel: 5, status: 'ACTIVE', skuLocked: true, createdAt: now, updatedAt: now },
  { id: 'V005', productId: 'P003', sku: 'LOG-GPX2-WHT', skuSource: 'AUTO', optionValues: [{ option: 'Màu', value: 'Trắng', code: 'WHT' }], purchasePrice: 2200000, serialTracking: false, reorderLevel: 5, status: 'ACTIVE', skuLocked: true, createdAt: now, updatedAt: now },
  { id: 'V006', productId: 'P004', sku: 'COR-K70-RD', skuSource: 'AUTO', optionValues: [{ option: 'Switch', value: 'Cherry MX Red', code: 'RD' }], purchasePrice: 2700000, serialTracking: false, reorderLevel: 3, status: 'ACTIVE', skuLocked: true, createdAt: now, updatedAt: now },
  { id: 'V007', productId: 'P004', sku: 'COR-K70-BL', skuSource: 'AUTO', optionValues: [{ option: 'Switch', value: 'Cherry MX Blue', code: 'BL' }], purchasePrice: 2700000, serialTracking: false, reorderLevel: 3, status: 'ACTIVE', skuLocked: true, createdAt: now, updatedAt: now },
  { id: 'V008', productId: 'P005', sku: 'LG-27GP950-BLK', skuSource: 'AUTO', optionValues: [{ option: 'Màu', value: 'Đen', code: 'BLK' }], purchasePrice: 13500000, serialTracking: false, reorderLevel: 3, status: 'ACTIVE', skuLocked: true, createdAt: now, updatedAt: now },
  { id: 'V009', productId: 'P006', sku: 'SAM-990P-2T', skuSource: 'AUTO', optionValues: [{ option: 'Dung lượng', value: '2TB', code: '2T' }], purchasePrice: 3000000, serialTracking: false, reorderLevel: 4, status: 'ACTIVE', skuLocked: true, createdAt: now, updatedAt: now },
]
