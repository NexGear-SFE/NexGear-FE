...
export const initialVariants: ProductVariant[] = [
  { id: 'V001', productId: 'P001', sku: 'ASU-G16-I9-4080', skuSource: 'AUTO', optionValues: [{ option: 'CPU', value: 'i9-14900HX', code: 'I9' }, { option: 'GPU', value: 'RTX 4080', code: '4080' }], storageLocation: 'Kệ A - Tầng 2', serialTracking: true, reorderLevel: 3, status: 'ACTIVE', skuLocked: true, createdAt: now, updatedAt: now },
  { id: 'V002', productId: 'P001', sku: 'ASU-G16-I7-4070', skuSource: 'AUTO', optionValues: [{ option: 'CPU', value: 'i7-14700HX', code: 'I7' }, { option: 'GPU', value: 'RTX 4070', code: '4070' }], storageLocation: 'Kệ A - Tầng 2', serialTracking: true, reorderLevel: 3, status: 'ACTIVE', skuLocked: true, createdAt: now, updatedAt: now },
  { id: 'V003', productId: 'P002', sku: 'MSI-GT77-I9-4090', skuSource: 'AUTO', optionValues: [{ option: 'CPU', value: 'i9-13980HX', code: 'I9' }, { option: 'GPU', value: 'RTX 4090', code: '4090' }], storageLocation: 'Kệ A - Tầng 3', serialTracking: true, reorderLevel: 2, status: 'ACTIVE', skuLocked: true, createdAt: now, updatedAt: now },
  { id: 'V004', productId: 'P003', sku: 'LOG-GPX2-BLK', skuSource: 'AUTO', optionValues: [{ option: 'Màu', value: 'Đen', code: 'BLK' }], storageLocation: 'Kệ B - Tầng 1', serialTracking: false, reorderLevel: 5, status: 'ACTIVE', skuLocked: true, createdAt: now, updatedAt: now },
  { id: 'V005', productId: 'P003', sku: 'LOG-GPX2-WHT', skuSource: 'AUTO', optionValues: [{ option: 'Màu', value: 'Trắng', code: 'WHT' }], storageLocation: 'Kệ B - Tầng 1', serialTracking: false, reorderLevel: 5, status: 'ACTIVE', skuLocked: true, createdAt: now, updatedAt: now },
  { id: 'V006', productId: 'P004', sku: 'COR-K70-RD', skuSource: 'AUTO', optionValues: [{ option: 'Switch', value: 'Cherry MX Red', code: 'RD' }], storageLocation: 'Kệ B - Tầng 2', serialTracking: false, reorderLevel: 3, status: 'ACTIVE', skuLocked: true, createdAt: now, updatedAt: now },
  { id: 'V007', productId: 'P004', sku: 'COR-K70-BL', skuSource: 'AUTO', optionValues: [{ option: 'Switch', value: 'Cherry MX Blue', code: 'BL' }], storageLocation: 'Kệ B - Tầng 2', serialTracking: false, reorderLevel: 3, status: 'ACTIVE', skuLocked: true, createdAt: now, updatedAt: now },
  { id: 'V008', productId: 'P005', sku: 'LG-27GP950-BLK', skuSource: 'AUTO', optionValues: [{ option: 'Màu', value: 'Đen', code: 'BLK' }], storageLocation: 'Kệ C - Tầng 1', serialTracking: false, reorderLevel: 3, status: 'ACTIVE', skuLocked: true, createdAt: now, updatedAt: now },
  { id: 'V009', productId: 'P006', sku: 'SAM-990P-2T', skuSource: 'AUTO', optionValues: [{ option: 'Dung lượng', value: '2TB', code: '2T' }], storageLocation: 'Kệ D - Tầng 1', serialTracking: false, reorderLevel: 4, status: 'ACTIVE', skuLocked: true, createdAt: now, updatedAt: now },
]
...
export const initialReceipts: StockReceipt[] = [
  ...
  { id: 'PN-20260815-002', supplier: 'ASUS Vietnam Co., Ltd.', warehouseName: 'Kho trung tâm TP.HCM', receiptDate: '2026-08-15', invoiceCode: 'INV-ASUS-2026-0815', notes: 'Lô ROG G16 đầu kỳ', creator: 'Nguyễn Bảo', status: 'CONFIRMED', lines: [{ id: 'RL003', variantId: 'V001', quantity: 5, unitCost: 40000000, serials: ['ROG16-4080-0001', 'ROG16-4080-0002', 'ROG16-4080-0003', 'ROG16-4080-SOLD1', 'ROG16-4080-SOLD2'] }], createdAt: '2026-08-15T08:30:00.000Z', updatedAt: '2026-08-15T09:00:00.000Z', confirmedBy: 'Nguyễn Bảo', confirmedAt: '2026-08-15T09:00:00.000Z' },
]
