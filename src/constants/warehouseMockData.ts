...
export const initialOrders: WarehouseOrder[] = [
  { id: '#GG-20260831-0182', customerName: 'Nguyễn Minh Tuấn', phone: '0912 345 678', address: '45 Nguyễn Huệ, P. Bến Nghé, Quận 1, TP. Hồ Chí Minh', paymentMethod: 'COD', state: 'WAITING_ACCEPTANCE', assignee: null, items: [{ id: 'OI001', variantId: 'V001', quantity: 1, unitPrice: 45990000, pickedQuantity: 0, assignedSerialIds: [] }], note: 'Giao giờ hành chính, gọi trước 30 phút', timeline: [{ id: 'T001', label: 'Đã tạo đơn hàng', occurredAt: '2026-08-31T08:14:00.000Z', actor: 'Khách hàng' }, { id: 'T002', label: 'Đã giữ hàng', occurredAt: '2026-08-31T08:14:00.000Z', actor: 'Hệ thống' }], createdAt: '2026-08-31T08:14:00.000Z' },
